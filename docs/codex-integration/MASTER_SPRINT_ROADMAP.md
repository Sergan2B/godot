...
`S5-01` и `S5-02` закрыты локально на macOS arm64: канонический
...
Следующий gate — совместимый Bridge RPC 1.4 profile `S5-03`; полная Sprint 5
приёмка пока не заявляется.
