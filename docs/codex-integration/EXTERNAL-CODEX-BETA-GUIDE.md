...
`0.1.12` candidate. Packages `0.1.2` through `0.1.11` remain immutable historical
...
old detached manifest, or relabel old evidence. Install `0.1.12` into
...
Package `0.1.12` can consume a later, independently released App/CLI/IDE
...
`0.1.12` package under `S11_CAPTURE_DATA_ROOT`; the fault-phase config or receipt
