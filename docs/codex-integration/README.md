...
24. [SPRINT-3-EVIDENCE.md](SPRINT-3-EVIDENCE.md) — superseded macOS evidence, the Windows portability correction, and current-freeze closure state.
...
| Sprint 3 Stage 5 | In progress on new freeze `1144694d2293`; prior macOS reports are stale after the Windows portability fix | Regenerate macOS, Windows, and Linux reports, aggregate them, and close `S3-09`/`S3-10` |
