...
impl DiagnosticCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ProjectSessionBusy => "project_session_busy",
...
const ALL_DIAGNOSTIC_SPECS: &[DiagnosticSpec] = &[
    ...
    DiagnosticSpec {
        code: DiagnosticCode::ProjectSessionBusy,
        severity: DiagnosticSeverity::Warning,
        component: Component::Sidecar,
        remediation_id: Some(RemediationId::WaitForProjectSession),
        retryable: true,
        summary: "Another Codex task owns this project's Godot session.",
    },
    DiagnosticSpec {
