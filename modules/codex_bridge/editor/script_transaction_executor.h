...
class ScriptTransactionExecutor : public TransactionExecutor {
public:
	static Error prepare_resolution(Node *p_scene_root, Node *p_target, const Dictionary &p_operation, TransactionPreviewBuilder::Resolution &r_resolution, String &r_error_code, String &r_error_message);
