...
EXACT_GODOT_PREREQUISITE_SHA256 = (
    "sha256:2166f3c6b7784cc7259a08a9636aafe89c8d6bebcbdc05c2b1d8d76933373dff"
)
...
REQUIRED_SOURCE_PATHS = frozenset(
    {
        ...
        "tests/codex/test_sprint11_same_project.py",
        ...
        commands=(
            GateCommand(
                ...
                argv=(
                    ...
                    "tests.codex.test_sprint11_same_project",
...
def validate_host_coordinate_profile(
    ...
    *,
    ...
    require(
        ...
        == "external-codex-beta-macos-arm64-hosts-v9",
